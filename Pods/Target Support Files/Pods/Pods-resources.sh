...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "MobilePrintSDK/Pod/Assets/MPMultipage.png"
  install_resource "MobilePrintSDK/Pod/Assets/MPMultipageLandscape.png"
